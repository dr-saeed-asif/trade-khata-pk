...
router.get('/conversations', (0, auth_middleware_1.authorizePermission)('ai.chat'), ai_controller_1.aiController.listConversations);
router.post('/conversations', (0, auth_middleware_1.authorizePermission)('ai.chat'), ai_controller_1.aiController.createConversation);
router.get('/conversations/:conversationId/messages', (0, auth_middleware_1.authorizePermission)('ai.chat'), ai_controller_1.aiController.getConversationMessages);
